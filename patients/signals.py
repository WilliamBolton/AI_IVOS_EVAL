...
def handle_logout(sender, request, **kwargs):
    ...
    csv_file_path = f'timing_results/{user_id}_page_visits.csv'
    ...
    csv_file_path2 = f'click_results/{user_id}_clicks.csv'
    ...
    csv_file_path3 = f'hover_results/{user_id}_hover_events.csv'
